...
class BucketImageView: UIImageView, CAAnimationDelegate {
    ...
    private func setup() {
        ...
        self.bucketLidLayer.contents = bucketLidImage.cgImage
        self.bucketLidLayer.frame = CGRect(x: 0, y: 0, width: bucketLidImage.size.width, height: bucketLidImage.size.height)

        self.bucketBodyLayer.contents = bucketBodyImage.cgImage
        self.bucketBodyLayer.frame = CGRect(x: 0, y: bucketLidImage.size.height + 2, width: bucketBodyImage.size.width, height: bucketBodyImage.size.height)
        ...
        self.bucketContainerLayer.addSublayer(bucketLidLayer)
        self.bucketContainerLayer.addSublayer(bucketBodyLayer)


        self.bucketContainerLayer.zPosition = 98
        self.micLayer.zPosition = 97
        self.layer.addSublayer(micLayer)
        self.layer.addSublayer(bucketContainerLayer)
