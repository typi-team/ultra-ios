...
extension UIColor {
    ...
    @nonobjc class var bgSurfaceMuted: UIColor {
        return UIColor(red: 247.0 / 255.0, green: 250.0 / 255.0, blue: 252.0 / 255.0, alpha: 1.0)
    }
    
    @nonobjc class var uiBlueMuted: UIColor {
        return UIColor(red: 191.0 / 255.0, green: 219.0 / 255.0, blue: 254.0 / 255.0, alpha: 1.0)
    }
    
    @nonobjc class var baseBlue: UIColor {
        return UIColor(red: 59.0 / 255.0, green: 130.0 / 255.0, blue: 246.0 / 255.0, alpha: 1.0)
    }
    
    @nonobjc class var textPrimary: UIColor {
        return UIColor(red: 17.0 / 255.0, green: 24.0 / 255.0, blue: 128.0 / 255.0, alpha: 1.0)
    }
