...
public class UltraSheetContentViewController: UIViewController {
    
    public private(set) var childViewController: UIViewController
    
    private var options: UltraSheetOptions
    ...
    public var treatPullBarAsClear: Bool = UltraSheetViewController.treatPullBarAsClear {
        didSet {
    ...
    weak var delegate: UltraSheetContentViewDelegate?
    ...
    public init(childViewController: UIViewController, options: UltraSheetOptions) {
...
extension UltraSheetContentViewController: UINavigationControllerDelegate {
