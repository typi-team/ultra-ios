...
struct InitSupportChatsRequest {
  ...
  struct Reception {
    ...
    var receptionService: String = String()
...
extension InitSupportChatsRequest.Reception: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
    ...
    3: .standard(proto: "reception_service"),
  ]
  ...
  mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    while let fieldNumber = try decoder.nextFieldNumber() {
      ...
      case 3: try { try decoder.decodeSingularStringField(value: &self.receptionService) }()
      default: break
      }
    }
  }
  ...
  func traverse<V: SwiftProtobuf.Visitor>(visitor: inout V) throws {
    ...
    if !self.receptionService.isEmpty {
      try visitor.visitSingularStringField(value: self.receptionService, fieldNumber: 3)
    }
    try unknownFields.traverse(visitor: &visitor)
  }
  ...
  static func ==(lhs: InitSupportChatsRequest.Reception, rhs: InitSupportChatsRequest.Reception) -> Bool {
    ...
    if lhs.receptionService != rhs.receptionService {return false}
    if lhs.unknownFields != rhs.unknownFields {return false}
    return true
  }
}
