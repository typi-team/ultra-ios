...
extension CoinTransferRequest: @unchecked Sendable {}
extension CoinTransferResponse: @unchecked Sendable {}
#endif  // swift(>=5.5) && canImport(_Concurrency)

// MARK: - Code below here is support for the SwiftProtobuf runtime.

extension CoinTransferRequest: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  static let protoMessageName: String = "CoinTransferRequest"
  ...
  static func ==(lhs: CoinTransferRequest, rhs: CoinTransferRequest) -> Bool {
...
extension CoinTransferResponse: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  static let protoMessageName: String = "CoinTransferResponse"
  static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
  ...
  static func ==(lhs: CoinTransferResponse, rhs: CoinTransferResponse) -> Bool {
