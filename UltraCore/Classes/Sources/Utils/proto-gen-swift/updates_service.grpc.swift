...
internal protocol UpdatesServiceClientInterceptorFactoryProtocol: GRPCSendable {
...
@available(macOS 10.15, iOS 13, tvOS 13, watchOS 6, *)
internal protocol UpdatesServiceAsyncProvider: CallHandlerProvider {
  static var serviceDescriptor: GRPCServiceDescriptor { get }
  var interceptors: UpdatesServiceServerInterceptorFactoryProtocol? { get }
...
internal protocol UpdatesServiceServerInterceptorFactoryProtocol {
