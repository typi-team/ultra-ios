...
internal protocol DeviceServiceClientInterceptorFactoryProtocol: GRPCSendable {
...
@available(macOS 10.15, iOS 13, tvOS 13, watchOS 6, *)
internal protocol DeviceServiceAsyncProvider: CallHandlerProvider {
  static var serviceDescriptor: GRPCServiceDescriptor { get }
  var interceptors: DeviceServiceServerInterceptorFactoryProtocol? { get }
...
internal protocol DeviceServiceServerInterceptorFactoryProtocol {
