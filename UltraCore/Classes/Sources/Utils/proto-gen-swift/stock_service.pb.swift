...
extension StockTransferRequest: @unchecked Sendable {}
extension StockTransferResponse: @unchecked Sendable {}
#endif  // swift(>=5.5) && canImport(_Concurrency)

// MARK: - Code below here is support for the SwiftProtobuf runtime.

extension StockTransferRequest: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  static let protoMessageName: String = "StockTransferRequest"
  ...
  static func ==(lhs: StockTransferRequest, rhs: StockTransferRequest) -> Bool {
...
extension StockTransferResponse: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  static let protoMessageName: String = "StockTransferResponse"
  static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
  ...
  static func ==(lhs: StockTransferResponse, rhs: StockTransferResponse) -> Bool {
